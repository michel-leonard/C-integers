...
There is a GitHub project that use this Big Numbers implementation, it's a Factorization software using [Quadratic Sieve](https://github.com/michel-leonard/C-Quadratic-Sieve) that is in **production** state.
